...
InGameHandling::InGameFunctionSignatures InGameHandling::LoadSignatures()
{
	...
	return {
		...
		, s.FindFunction<decltype(IGFS::lua_gc)>(
			"\x8B\x44\x24\x04\x53\x56\x8B\xD9\x57\x8B\x73\x10\x33\xFF\xFF\x24")
		...
		, s.FindFunction<decltype(IGFS::luaC_fullgc)>(
			"\x56\x57\x8B\xF9\x8B\x77\x10\x80\x7E\x15\x01\x77\x26\x8D\x46\x1C")
